...
function timelineList() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        expect(timelineListResponse.data.timeline_entries[1].id).toBe(comment1.data.timeline_entry.id);
        expect(timelineListResponse.data.timeline_entries[2].id).toBe(comment2.data.timeline_entry.id);
    });
}
